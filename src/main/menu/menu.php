<html>
    ...
    <body>
        ...
        <div id="menu_grid">
            ...
            <a href="/WebEfectividad_2022/src/main/peticiones/lista/administrar/lista_pet.php"><img src="/WebEfectividad_2022/src/resources/Menu/Administrar.png" alt="Administrar"></a>
        </div>
        <?php
